      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg text-white font-semibold transition-opacity"
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <button
        ...
        className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg text-white font-semibold text-base transition-opacity disabled:opacity-60"
        style={{ backgroundColor: "#e94560" }}
      >
